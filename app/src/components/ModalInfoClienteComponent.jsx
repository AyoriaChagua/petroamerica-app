...
import { ActivityIndicator, Colors, Divider, Modal, Portal } from 'react-native-paper'
import { HeaderModal } from './HeaderModal'
import {helpers} from '../helpers/helpers'
import { Picker } from '@react-native-picker/picker'

export const ModalInfoClienteComponent = ({verModal, cerrarModal, documentos, listaPlantas, titulo, filtroSeleccionado, seleccionarDelFiltro, cargaInformacion, tipoVentaDocDeuda, saldoTotalDoc, botonEfeact = false}) => {
              ...
              
              {
                (cargaInformacion)
                  ...
                  : 
                    <>
                      <FlatList
                          data = {filtroSeleccionado === "" ? documentos : documentos.filter(value => value.planta === filtroSeleccionado)}
